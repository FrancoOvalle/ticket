...
<?php
    if($action == 'ajax'){
        // escaping, additionally removing everything that could be (html/javascript-) code
         ...
         $aColumns = array('title','num_ticket');//Columnas de busqueda
         $sTable = "ticket";
         $sWhere = "";
        ...
        if ($_SESSION['tipo_us']==2){
            if ( $_GET['q'] != ""  )
            {
                ...
                $sWhere .= ') AND user_id='.$user.' order by created_at desc';
            }else{
                $sWhere.="where user_id=".$user." order by created_at desc";
            }
                ...
                ?>
                 ...
                 <input type="hidden" value="<?php echo $kind_id;?>" id="kind_id<?php echo $id;?>">
                    ...
                    <?php
                        ...
                        if($status_id == "1"){ ?>
                            <tr class="even pointer bg-orange">
                        <?php } ?>
                        
                        <?php if($status_id == "3"){?>
                            <tr class="even pointer bg-green">
                           <?php } ?>
                           <?php if($status_id == "2"){?>
                            <tr class="even pointer bg-blue">
                           <?php } ?>
                           <?php if($status_id == "4"){?>
                            <tr class="even pointer bg-red">
                           <?php } ?>
                       
                        <td><?php echo $num; ?></td>
                        <td><?php echo $title;?></td>
                        <td><?php echo $name_project; ?></td>
                        <td><?php echo $name_us; ?></td>
                        <td><?php echo $name_priority; ?></td>
                        <td><?php echo $name_status;?></td>
                        <td><?php echo $created_at;?></td>
                        <td ><span class="pull-right">
                            <?php if($_SESSION['tipo_us']==2){}else{?>
