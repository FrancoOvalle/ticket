                ...
                <div class="modal-body">
                    <form class="form-horizontal form-label-left input_mask" id="upd_user" name="upd_user">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                <input type="text" id="mod_username" class="form-control" name="mod_username" placeholder="Username" required>
                                <span class="fa fa-user form-control-feedback right" aria-hidden="true"></span>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Dependencia
                            </label>
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <select class="form-control" name="mod_depend_id" required id="mod_depend_id">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <select class="form-control" name="mod_unid_id" required id="mod_unid_id">
                                    <option selected="" value="">-- Selecciona --</option>
