        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu"><!-- sidebar menu -->
            <div class="menu_section">
                <ul class="nav side-menu">
                    ...
                    <li class="<?php if(isset($active3)){echo $active3;} if($_SESSION['tipo_us']==2){ echo 'hidden';}?>">
                        <a href="projects.php"><i class="fa fa-list-alt"></i> Dependecias</a>
                    </li>

                    <li class="<?php if(isset($active4)){echo $active4;}if($_SESSION['tipo_us']==2){ echo 'hidden';} ?>">
                        <a href="categories.php"><i class="fa fa-align-left"></i> Unidades</a>
                    </li>

                    <li class="<?php if(isset($active5)){echo $active5;} if($_SESSION['tipo_us']==2){ echo 'hidden';}?>">
                        <a href="reports.php"><i class="fa fa-area-chart"></i> Reportes</a>
                    </li>

                    <li class="<?php if(isset($active6)){echo $active6;} if($_SESSION['tipo_us']==2){ echo 'hidden';}?>">
